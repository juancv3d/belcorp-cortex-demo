-- ============================================================================
-- QUERY 1: % de cumplimiento de venta planificada por marca-categoria-campana
-- Ticket: DST-847 | Criterio de Aceptacion #1
...
SELECT
    ...
    CASE
        ...
        WHEN COALESCE(vr.VENTA_REAL, 0) >= mc.MUST_HAVE_VENTA   THEN 'Cumple Must-Have'
        ELSE 'Por Debajo Must-Have'
